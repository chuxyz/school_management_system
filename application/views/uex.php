...
<div class="title-block"><h3>Update Exam - <?php echo $subject_name; ?></h3></div>
<?php
...
{
	$ft_val = @$this->action_model->get_assessment($class_id, $student->studentID, $subject_id, $term_id, $session_id)->exam;
	echo '<tr>
	<td><span>'.$sn.'</span></td>
...
<input type="submit" name="uex" value="Submit" class="button" style="float:right; margin-right:11%;" />
</form>
</div>
</div>
