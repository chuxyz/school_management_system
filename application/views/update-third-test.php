...
<div id="main-panel">
<div id="main">
<div class="title-block"><h3>Update Third Test</h3></div>
<?php
...
<label class="label" style="margin-right:15px;">&nbsp;</label><input type="submit" name="third-test" value="Go!" class="button" /> 
</form>
</div>
</div>
