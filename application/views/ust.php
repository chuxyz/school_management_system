...
<div class="title-block"><h3>Update Second Test - <?php echo $subject_name; ?></h3></div>
<?php
...
{
	$ft_val = @$this->action_model->get_assessment($class_id, $student->studentID, $subject_id, $term_id, $session_id)->test2;
	echo '<tr>
	<td><span>'.$sn.'</span></td>
...
<input type="submit" name="ust" value="Submit" class="button" style="float:right; margin-right:11%;" />
</form>
</div>
</div>
...
<li><a href="<?php echo base_url('update-second-test'); ?>"  class="active">Update Second Test</a></li>
