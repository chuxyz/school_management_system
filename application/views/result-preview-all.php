...
{
	$result = $this->action_model->get_result($class_id, $st->studentID, $term_id, $session_id);
	$err = 0;
...
<img src="<?php echo base_url($st->passport); ?>" />
<span><?php echo $st->studentName; ?></span>
...
<td>
<?php
$staffcomment = @$this->action_model->get_staffcomment($st->studentID, $term_id, $session_id);
...
<?php
$psy = @$this->action_model->get_psycho($st->studentID, $term_id, $session_id)->psyValues;
$psyV = @explode('-',$psy);
?>
<table>
